...
### 完成标准
- [ ] Skill Prompt/描述足够详细，可直接用于 AI 系统配置
- [ ] 交互流程覆盖所有调研维度（宏观4维度 + 微观4维度）
- [ ] 模拟用户数据结构定义完整（字段、类型、约束、JSON Schema）
- [ ] 报告模板可直接填充使用
- [ ] 包含至少一个端到端示例
- [ ] 所有文档符合 AGENTS.md 中的内容规范（简体中文、Markdown 风格）
...
- [ ] 所有「必须包含」项均已体现在设计文档中
- [ ] 所有「必须不包含」项均未出现
- [ ] `市场调研思路.md` 的 8 个维度 100% 覆盖
- [ ] 模拟用户系统的三大能力（Kano/访谈/投票）均有完整设计
- [ ] 报告模板可直接使用
- [ ] 端到端示例完整且自洽
- [ ] 所有文档符合 AGENTS.md 内容规范
